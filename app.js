...
function showMainHome() {
    ...
    if (container) {
        ...
        container.innerHTML = `<section class="home-content" aria-label="사이트 소개"><h2>한국어 유대교 문헌 번역 아카이브</h2><p>Jewish Korean은 토라와 유대교 문헌을 한국어로 읽고 공부할 수 있도록 정리하는 독립 번역 프로젝트입니다. 현재 슈모트와 바이크라 본문, 미슈나 제라임, 슈타인잘쯔 토라 강의, 노아하이드 강의를 제공합니다.</p><p>대화형 메뉴에서 장과 파라샤를 선택해 읽거나, 검색엔진에서 각 문서를 찾기 쉬운 <a href="archive/index.html">문헌 아카이브 페이지</a>를 이용할 수 있습니다.</p><div class="home-directory"><a href="archive/index.html">전체 문헌 아카이브</a><a href="jewish-terms.html">유대교 용어 검색어</a><a href="AI-Korean/index.html">한국어 학습</a></div></section>`;
    }
